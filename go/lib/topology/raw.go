...
func (b RawBRIntf) localTopoAddr(o overlay.Type) (*TopoAddr, error) {
	s := &RawBRIntAddr{
		PublicOverlay: []RawAddrOverlay{*b.PublicOverlay},
	}
	if b.BindOverlay != nil {
		s.BindOverlay = []RawAddr{*b.BindOverlay}
	}
	return s.intTopoAddr(o)
}
