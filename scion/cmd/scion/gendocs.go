...
func newGendocs(pather CommandPather) *cobra.Command {
	var cmd = &cobra.Command{
		...
		Short:   "Generate documentation for scion CLI tool",
		Example: fmt.Sprintf("  %[1]s gendocs doc/command/scion", pather.CommandPath()),
		Long: `'gendocs' generate documentation for the scion CLI tool.

This command creates and stores the RST documentation for the scion CLI tool
