...
// Source: github.com/scionproto/scion/private/trust (interfaces: DB,Fetcher,Inspector,KeyRing,Provider,Recurser,Router,SignerGenerator)
...
import (
	...
	trust "github.com/scionproto/scion/private/trust"
)
...
// MockSignerGenerator is a mock of SignerGenerator interface.
type MockSignerGenerator struct {
	ctrl     *gomock.Controller
	recorder *MockSignerGeneratorMockRecorder
}

// MockSignerGeneratorMockRecorder is the mock recorder for MockSignerGenerator.
type MockSignerGeneratorMockRecorder struct {
	mock *MockSignerGenerator
}

// NewMockSignerGenerator creates a new mock instance.
func NewMockSignerGenerator(ctrl *gomock.Controller) *MockSignerGenerator {
	mock := &MockSignerGenerator{ctrl: ctrl}
	mock.recorder = &MockSignerGeneratorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSignerGenerator) EXPECT() *MockSignerGeneratorMockRecorder {
	return m.recorder
}

// Generate mocks base method.
func (m *MockSignerGenerator) Generate(arg0 context.Context) (trust.Signer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSignerGeneratorMockRecorder) Generate(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Generate", reflect.TypeOf((*MockSignerGenerator)(nil).Generate), arg0)
}
