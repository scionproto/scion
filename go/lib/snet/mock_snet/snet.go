...
// Source: github.com/scionproto/scion/go/lib/snet (interfaces: PacketDispatcherService,Network,PacketConn,Path,PathInterface,PathMetadata,PathQuerier,Router,RevocationHandler)
...
// MockPathInterface is a mock of PathInterface interface
type MockPathInterface struct {
	ctrl     *gomock.Controller
	recorder *MockPathInterfaceMockRecorder
}

// MockPathInterfaceMockRecorder is the mock recorder for MockPathInterface
type MockPathInterfaceMockRecorder struct {
	mock *MockPathInterface
}

// NewMockPathInterface creates a new mock instance
func NewMockPathInterface(ctrl *gomock.Controller) *MockPathInterface {
	mock := &MockPathInterface{ctrl: ctrl}
	mock.recorder = &MockPathInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockPathInterface) EXPECT() *MockPathInterfaceMockRecorder {
	return m.recorder
}

// IA mocks base method
func (m *MockPathInterface) IA() addr.IA {
	m.ctrl.T.Helper()
...
func (mr *MockPathInterfaceMockRecorder) IA() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IA", reflect.TypeOf((*MockPathInterface)(nil).IA))
}

// ID mocks base method
func (m *MockPathInterface) ID() common.IFIDType {
	m.ctrl.T.Helper()
...
func (mr *MockPathInterfaceMockRecorder) ID() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ID", reflect.TypeOf((*MockPathInterface)(nil).ID))
}
