...
/****************************************************************************/
#pragma implementation "ASBarabasiAlbertModel-2.h"

#include "ASBarabasiAlbertModel-2.h"

ASBarabasiAlbert_2::ASBarabasiAlbert_2(ASBarabasiAlbert_2_Par* par) {
...
string ASBarabasiAlbert_2::ToString() {
...
void ASBarabasiAlbert_2::InterconnectNodes(Graph *g) {
  ...
  cout << "ASBarabasiAlbert-2: Interconnecting nodes...\n";
  ...
  while (added_nodes < g->GetNumNodes() - 1) {
	...
	try {
	  ...
	  cerr << "ASBarabasiAlbert-2->Interconnect(): Cannot allocate new edge...\n" << flush;
	  exit(0);
	}	
