...
config (generalized per-host configuration), crypto (TRCs and certificates),
clab and instructions.`,
		Args:          cobra.NoArgs,
		SilenceErrors: true,
		Example:       "  testgen --topo topology/default.topo -o gen",
	...
	c.Flags().StringVar(&flags.topo, "topo", "topology/default.topo",
