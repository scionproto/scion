...
func InitTestConfig(cfg *Config) {
	envtest.InitTest(&cfg.General, &cfg.Features, &cfg.Logging, &cfg.Metrics, nil, nil)
...
func CheckTestConfig(cfg *Config, id string) {
	envtest.CheckTest(&cfg.General, &cfg.Features, &cfg.Logging, &cfg.Metrics, nil, nil, id)
