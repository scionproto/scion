...
func (rp *RPkt) validatePath(dirFrom Dir) *common.Error {
	if assert.On {
		assert.Must(rp.ifCurr != nil, "RPkt.validatePath: rp.ifCurr is nil")
	}
...
func (rp *RPkt) InfoF() (*spath.InfoField, *common.Error) {
	if rp.infoF == nil {
...
func (rp *RPkt) HopF() (*spath.HopField, *common.Error) {
	if rp.hopF == nil {
...
func (rp *RPkt) getHopFVer(dirFrom Dir) common.RawBytes {
...
func (rp *RPkt) hopFVerFromRaw(offset int) common.RawBytes {
...
func (rp *RPkt) incPath() *common.Error {
	var err *common.Error
...
func (rp *RPkt) UpFlag() (*bool, *common.Error) {
	if rp.upFlag != nil {
...
func (rp *RPkt) IFCurr() (*spath.IntfID, *common.Error) {
	if rp.ifCurr != nil {
...
func (rp *RPkt) checkSetCurrIF(ifid *spath.IntfID) (*spath.IntfID, *common.Error) {
	if ifid == nil {
...
func (rp *RPkt) IFNext() (*spath.IntfID, *common.Error) {
...
func (rp *RPkt) hookIF(up bool, hooks []HookIntf) (*spath.IntfID, *common.Error) {
	for _, f := range hooks {
