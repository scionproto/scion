...
func (rp *RPkt) L4Hdr() (l4.L4Header, *common.Error) {
	if rp.l4 == nil {
...
func (rp *RPkt) findL4() (bool, *common.Error) {
...
func (rp *RPkt) verifyL4Chksum() *common.Error {
	switch h := rp.l4.(type) {
...
func (rp *RPkt) getChksumInput() (src, dst, pld common.RawBytes) {
...
func (rp *RPkt) updateL4() *common.Error {
	switch h := rp.l4.(type) {
	case *l4.UDP, *scmp.Hdr:
		src, dst, pld := rp.getChksumInput()
		h.SetPldLen(len(pld))
