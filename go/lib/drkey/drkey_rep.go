...
func (c *DRKeyRep) String() string {
	return fmt.Sprintf("Src ISD-AS: %s Timestamp: %v ExpTime: %v CertVerSig: %v CertVerEnc: %v CertVerEnc: %v",
		c.IA(), c.Timestamp, c.ExpTime, c.CertVerEnc, c.CertVerEnc, c.TrcVer)
}
