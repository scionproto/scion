...
ROOTTYPES="ASEntry CtrlPld PathSegment PathSegmentSignedData RevInfo SignedBlob SignedCtrlPld SVCResolutionReply ColibriRequestPayload CertChainRenewalRequest CertChainRenewalReply SegRecs"
