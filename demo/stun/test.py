...
class Test(base.TestTopogen):
    def setup_prepare(self):
        ...
        # (192.168.123.0/24).
        # A new docker container is added which acts as a NAT between the new network and
        # AS1-ff00:0:111 (172.20.0.24/29).
        # The tester container of AS1-ff00:0:111 is moved inside the separate network, along with
        # the accompanying daemon and dispatcher.
        with (open(self.artifacts / "gen/scion-dc.yml", "r") as file):
            ...
            scion_dc["services"]["sd1-ff00_0_111"]["volumes"][1] = \
                scion_dc["services"]["sd1-ff00_0_111"]["volumes"][1][:-2] + "rw"
    ...
    def _run(self):
        ...
        self.dc.execute_detached("tester_1-ff00_0_110", "bash", "-c",
                                 "test-server -local 1-ff00:0:110,172.20.0.22:31000")
        time.sleep(3)
