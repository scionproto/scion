...
class TestASMarkingSigPack(object):
    ...
    def test_9(self):
        ...
        rev0 = RevocationInfo.from_values(1, 0, "abcd", [], "qw", "er").p
        rev1 = RevocationInfo.from_values(1, 0, "abcd", [], "qw", "er").p
        exts = create_mock_full({"revInfos": [rev0, rev1]})
        ...
        expected = b"".join([
            ...
            b"pcbm 0", b"pcbm 1", b"pcbm 2", b"eg rev", b"\x10\x0bP\x02\x04" +
            b"\x01\x01\x00\x00\x11\r\"\x11\r\x07\x11\r\x12\x11\r\x12\x0fabc" +
            b"dP\x01\x01\x03qw\x03er\x10\x0bP\x02\x04\x01\x01\x00\x00\x11\r" +
            b"\"\x11\r\x07\x11\r\x12\x11\r\x12\x0fabcdP\x01\x01\x03qw\x03er",
