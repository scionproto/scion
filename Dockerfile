...
# TODO: check if this is still needed; RUN cd /etc/apt/apt.conf.d/ && rm 01autoremove 01autoremove-kernels
...
RUN bash -c 'DEBIAN_FRONTEND=noninteractive apt-get autoremove'
