...
func (rp *RPkt) SrcIA() (*addr.ISD_AS, *common.Error) {
	if rp.srcIA == nil {
...
func (rp *RPkt) DstIA() (*addr.ISD_AS, *common.Error) {
	if rp.dstIA == nil {
		var err *common.Error
...
func (rp *RPkt) hookIA(hooks []HookIA, idx int) (*addr.ISD_AS, *common.Error) {
	for _, f := range hooks {
		ret, ia, err := f()
		switch {
		case err != nil:
...
func (rp *RPkt) SrcHost() (addr.HostAddr, *common.Error) {
	if rp.srcHost == nil {
		var err *common.Error
...
func (rp *RPkt) DstHost() (addr.HostAddr, *common.Error) {
	if rp.dstHost == nil {
		var err *common.Error
