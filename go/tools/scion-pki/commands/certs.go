...
import (
	...
	certs "github.com/scionproto/scion/go/tools/scion-pki/internal/certs"
)
...
func init() {
	...
	certCmd.PersistentFlags().BoolVarP(&verify, "verify", "v", true, "verify the generated/renewd certificates")
	certCmd.AddCommand(genCerts)
	certCmd.AddCommand(renewCerts)
	certCmd.AddCommand(cleanCerts)
}
