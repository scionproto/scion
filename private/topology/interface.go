...
type Topology interface {
	...
	UnderlayNextHop(ifID ifid.IfIDType) (*net.UDPAddr, bool)
...
func (t *topologyS) IfIDs() []ifid.IfIDType {
	intfs := make([]ifid.IfIDType, 0, len(t.Topology.IFInfoMap))
...
func (t *topologyS) UnderlayNextHop(ifID ifid.IfIDType) (*net.UDPAddr, bool) {
