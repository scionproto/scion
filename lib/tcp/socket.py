...
class SCIONSocket(object):
    ...
    def __init__(self, family, type_, proto=0, sock=None):
    ...
    def _from_lwip(self):
        ...
        logging.debug("Reading from LWIP(%dB): %.*s..." % (len(rep), 20, rep))
        return rep
    ...
    def accept(self):
        ...
        sock = SCIONSocket(self.family, self.type, self.proto, new_sock)
    ...
    def settimeout(self, timeout):  # Timeout is given as a float
...
def socket(family, type_, proto=0):
    return SCIONSocket(family, type_, proto)
