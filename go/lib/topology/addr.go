...
func (t *TopoAddr) PubL4PortFromAddr(a addr.HostAddr) (int, bool) {
	// TODO(klausman) instead of int/bool, return int/err
	switch a := a.(type) {
	case *addr.HostIPv4:
		if t.IPv4 == nil || !t.Overlay.IsIPv4() {
			return 0, false
		}
		return t.IPv4.pubL4Port, t.IPv4.pubIP.Equal(a.IP())
	case *addr.HostIPv6:
		if t.IPv6 == nil || !t.Overlay.IsIPv6() {
			return 0, false
		}
		return t.IPv6.pubL4Port, t.IPv6.pubIP.Equal(a.IP())
	default:
