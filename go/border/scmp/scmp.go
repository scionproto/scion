...
var typeNameMap = map[Class][]string{
	C_General: []string{"UNSPECIFIED", "ECHO_REQEST", "ECHO_REPLY"},
	C_Routing: []string{"UNREACH_NET", "UNREACH_HOST", "L2_ERROR", "UNREACH_PROTO",
		"UNREACH_PORT", "UNKNOWN_HOST", "BAD_HOST", "OVERSIZE_PKT", "ADMIN_DENIED"},
	C_CmnHdr: []string{"BAD_VERSION", "BAD_SRC_TYPE", "BAD_DST_TYPE",
		"BAD_PKT_LEN", "BAD_IOF_OFFSET", "BAD_HOF_OFFSET"},
	C_Path: []string{"PATH_REQUIRED", "BAD_MAC", "EXPIRED_HOPF", "BAD_IF", "REVOKED_IF",
		"NON_ROUTING_HOPF", "DELIVERY_FWD_ONLY", "DELIVERY_NON_LOCAL"},
	C_Ext:   []string{"TOO_MANY_HOPBYHOP", "BAD_EXT_ORDER", "BAD_HOPBYHOP", "BAD_END2END"},
	C_Sibra: []string{"SIBRA_BAD_VERSION", "SIBRA_SETUP_NO_REQ"},
}
