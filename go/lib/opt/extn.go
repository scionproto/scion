...
0B       1        2        3        4        5        6        7
+--------+--------+--------+--------+--------+--------+--------+--------+
| xxxxxxxxxxxxxxxxxxxxxxHx |                    padding                 |
+--------+--------+--------+--------+--------+--------+--------+--------+
|                               DataHash...                             |
+--------+--------+--------+--------+--------+--------+--------+--------+
|                            ...DataHash                                |
...
func ExtnFromRaw(b common.RawBytes) (*Extn, *common.Error) {
	e := &Extn{}
	flags := b[0]
	e.HopByHop = (flags & ExtnHBHFlag) != 0 // mask out the HopByHop flag and check if set
	e.DataHash = b[8:23]
	e.SessionId = b[24:39]
	e.PVF = b[40:55]
	return e, nil
...
func (e *Extn) Len() int {
	return common.ExtnFirstLineLen + len(Extn.SessionId) + len(Extn.PVF)
}
...
func (e *Extn) String() string {
	return fmt.Sprintf("OPT Ext(%dB): Error? %v HopByHop: %v", e.Len(), e.Error, e.HopByHop)
}
...
func (e *Extn) Write(b common.RawBytes) *common.Error {
	...
	copy(b[1:7], make(common.RawBytes, common.ExtnFirstLineLen-1))
	b[8:23] = e.DataHash
	b[24:39] = e.SessionId
	b[40:55] = e.PVF
	return nil
