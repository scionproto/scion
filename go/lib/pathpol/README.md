...
git repository, in `sequence` subdirectory. That way the project doesn't have build dependency on
Antlr tool. However, there's still the dependency on Antlr runtime library.
