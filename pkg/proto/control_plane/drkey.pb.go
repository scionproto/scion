...
const file_proto_control_plane_v1_drkey_proto_rawDesc = "" +
	"\n" +
	"\"proto/control_plane/v1/drkey.proto\x12\x16proto.control_plane.v1\x1a\x1aproto/drkey/v1/drkey.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8b\x01\n" +
	"\x17DRKeySecretValueRequest\x125\n" +
	...
	"protocolId\"\xa2\x01\n" +
	"\x18DRKeySecretValueResponse\x12;\n" +
	...
	"\x03key\x18\x03 \x01(\fR\x03key\"\x86\x01\n" +
	"\x12DRKeyLevel1Request\x125\n" +
	"\bval_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\avalTime\x129\n" +
	"\vprotocol_id\x18\x02 \x01(\x0e2\x18.proto.drkey.v1.ProtocolR\n" +
	"protocolId\"\x9d\x01\n" +
	"\x13DRKeyLevel1Response\x12;\n" +
	"\vepoch_begin\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"epochBegin\x127\n" +
	"\tepoch_end\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\bepochEnd\x12\x10\n" +
	"\x03key\x18\x03 \x01(\fR\x03key\"\xb9\x01\n" +
	"\x17DRKeyIntraLevel1Request\x125\n" +
	"\bval_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\avalTime\x129\n" +
	"\vprotocol_id\x18\x02 \x01(\x0e2\x18.proto.drkey.v1.ProtocolR\n" +
	"protocolId\x12\x15\n" +
	"\x06src_ia\x18\x03 \x01(\x04R\x05srcIa\x12\x15\n" +
	"\x06dst_ia\x18\x04 \x01(\x04R\x05dstIa\"\xa2\x01\n" +
	"\x18DRKeyIntraLevel1Response\x12;\n" +
	"\vepoch_begin\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"epochBegin\x127\n" +
	"\tepoch_end\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\bepochEnd\x12\x10\n" +
	...
	"epochBegin\x127\n" +
	"\tepoch_end\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\bepochEnd\x12\x10\n" +
	"\x03key\x18\x03 \x01(\fR\x03key2}\n" +
	"\x11DRKeyInterService\x12h\n" +
	"\vDRKeyLevel1\x12*.proto.control_plane.v1.DRKeyLevel1Request\x1a+.proto.control_plane.v1.DRKeyLevel1Response\"\x002\xc9\x04\n" +
	"\x11DRKeyIntraService\x12w\n" +
	"\x10DRKeyIntraLevel1\x12/.proto.control_plane.v1.DRKeyIntraLevel1Request\x1a0.proto.control_plane.v1.DRKeyIntraLevel1Response\"\x00\x12h\n" +
	"\vDRKeyASHost\x12*.proto.control_plane.v1.DRKeyASHostRequest\x1a+.proto.control_plane.v1.DRKeyASHostResponse\"\x00\x12h\n" +
	"\vDRKeyHostAS\x12*.proto.control_plane.v1.DRKeyHostASRequest\x1a+.proto.control_plane.v1.DRKeyHostASResponse\"\x00\x12n\n" +
	"\rDRKeyHostHost\x12,.proto.control_plane.v1.DRKeyHostHostRequest\x1a-.proto.control_plane.v1.DRKeyHostHostResponse\"\x00\x12w\n" +
	"\x10DRKeySecretValue\x12/.proto.control_plane.v1.DRKeySecretValueRequest\x1a0.proto.control_plane.v1.DRKeySecretValueResponse\"\x00B5Z3github.com/scionproto/scion/pkg/proto/control_planeb\x06proto3"

var (
	file_proto_control_plane_v1_drkey_proto_rawDescOnce sync.Once
	file_proto_control_plane_v1_drkey_proto_rawDescData []byte
)

func file_proto_control_plane_v1_drkey_proto_rawDescGZIP() []byte {
	file_proto_control_plane_v1_drkey_proto_rawDescOnce.Do(func() {
		file_proto_control_plane_v1_drkey_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_control_plane_v1_drkey_proto_rawDesc), len(file_proto_control_plane_v1_drkey_proto_rawDesc)))
	})
...
var file_proto_control_plane_v1_drkey_proto_goTypes = []any{
...
func file_proto_control_plane_v1_drkey_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_control_plane_v1_drkey_proto_rawDesc), len(file_proto_control_plane_v1_drkey_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   2,
