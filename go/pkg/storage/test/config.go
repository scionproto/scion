...
func CheckTestBeaconDBConfig(t *testing.T, cfg *storage.DBConfig, id string) {
	assert.Equal(t, storage.SetID(storage.SampleBeaconDB, id), cfg)
}

func CheckTestPathDBConfig(t *testing.T, cfg *storage.DBConfig, id string) {
