...
// handlePacketError is called to enqueue packets with protocol-level errors
...
func (r *Router) doPktError(rp *rpkt.RtrPkt, perr error) {
	...
	rp.Debug("", "srcIA", srcIA, "rp", rp)
	rp.Debug("", "rp.Ctx", rp.Ctx)
	rp.Debug("", "rp.Ctx.Conf", rp.Ctx.Conf)
