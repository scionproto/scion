...
urlpatterns = patterns('',
    ...
    url(r'^ads/(?P<pk>\d+)/#!topology$', views.ADDetailView.as_view(), name='ad_detail_topology'),
    ...
    url(r'^ads/(?P<pk>\d+)/send_update$', views.send_update, name='send_update'),
    url(r'^ads/(?P<pk>\d+)/download_update$', views.download_update, name='download_update'),
)