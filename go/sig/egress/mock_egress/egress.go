...
// Source: github.com/scionproto/scion/go/sig/egress (interfaces: Session)
...
import (
	...
	egress "github.com/scionproto/scion/go/sig/egress"
...
func (m *MockSession) PathPool() egress.PathPool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PathPool")
	ret0, _ := ret[0].(egress.PathPool)
	return ret0
}
...
func (m *MockSession) Remote() *egress.RemoteInfo {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Remote")
	ret0, _ := ret[0].(*egress.RemoteInfo)
	return ret0
}
