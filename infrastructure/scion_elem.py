...
class SCIONElement(object):
    ...
    :ivar dict id_er: map of interface ID to Routerelement.
    ...
    def init_id_er(self):
        for er in self.topology.get_all_edge_routers():
            self.id_er[er.interface.if_id] = er
    ...
    def get_first_hop(self, spkt):
        ...
        if if_id in self.id_er:
            return self.id_er[if_id].addr, SCION_UDP_EH_DATA_PORT
