...
func TestBadPeering(t *testing.T) {
	...
	g.DeleteInterface(generated.If_111_C_121_X)
	...
	testCases := []struct {
	...
	}{
		{
			...
			Ups: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_130_B_111_A, generated.If_111_A_112_X}),
			},
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_120_A_130_B}),
			},
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_120_B_121_X, generated.If_121_X_122_X}),
			},
		},
	}
...
func TestMiscPeering(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X_110_X, generated.If_110_X_130_A}),
			},
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X_211_A, generated.If_211_A_212_X}),
			},
		},
		{
			...
			Ups: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_130_A_131_X}),
			},
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{
					generated.If_220_X_210_X, generated.If_210_X_110_X, generated.If_110_X_130_A}),
			},
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_220_X_221_X}),
			},
		},
	}
...
func TestSameCoreParent(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_130_A_112_X}),
			},
		},
	}
...
func TestLoops(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			DstIA:    addr.MustParseIA("1-ff00:0:112"),
			Ups: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_120_X_111_B}),
				g.Beacon([]uint16{generated.If_130_B_111_A}),
			},
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_130_B_120_A}),
				g.Beacon([]uint16{generated.If_120_A_130_B}),
				g.Beacon([]uint16{generated.If_120_A_110_X, generated.If_110_X_130_A}),
				g.Beacon([]uint16{generated.If_130_A_110_X, generated.If_110_X_120_A}),
			},
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_130_A_112_X}),
				g.Beacon([]uint16{generated.If_130_B_111_A, generated.If_111_A_112_X}),
				g.Beacon([]uint16{generated.If_120_X_111_B, generated.If_111_A_112_X}),
			},
		},
	}
	t.Log("TestLoops")
...
func TestComputePath(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_110_X_130_A}),
			},
		},
		{
		...
		},
		{
			...
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_120_B_121_X}),
			},
		},
		{
		...
		},
		{
			...
			DstIA:    addr.MustParseIA("2-ff00:0:212"),
			Ups: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_130_A_131_X, generated.If_131_X_132_X}),
			},
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X_110_X, generated.If_110_X_130_A}),
			},
		...
		},
		{
			...
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X1_211_A}),
			},
		},
		{
			Name:     "#9 missing down",
		...
		},
		{
			...
			Ups: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X1_211_A, generated.If_211_A1_212_X}),
			},
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X1_211_A, generated.If_211_A_222_X}),
			},
		},
		{
			...
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_220_X_210_X}),
			},
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_220_X_221_X, generated.If_221_X_222_X}),
			},
		},
		{
		...
		},
		{
			...
			DstIA:    addr.MustParseIA("2-ff00:0:222"),
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X_110_X}),
				g.Beacon([]uint16{generated.If_220_X_210_X, generated.If_210_X_110_X}),
			},
			Downs: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X1_211_A, generated.If_211_A_222_X}),
				g.Beacon([]uint16{generated.If_220_X_221_X, generated.If_221_X_222_X}),
		...
		},
		{
			...
			Cores: []*seg.PathSegment{
				g.Beacon([]uint16{generated.If_210_X_110_X, generated.If_110_X_130_A}),
				g.Beacon([]uint16{generated.If_210_X_110_X, generated.If_110_X_120_A,
					generated.If_120_A_130_B}),
				g.Beacon([]uint16{generated.If_210_X_220_X, generated.If_220_X_120_B,
					generated.If_120_A_110_X, generated.If_110_X_130_A}),
			},
		},
	}
