...
func RPktFromSpkt(sp *spkt.SPkt, dirTo Dir) (*RPkt, *common.Error) {
	rp := NewRPkt()
	hdrLen := sp.HdrLen()
...
func (rp *RPkt) addL4(l4h l4.L4Header) *common.Error {
...
func (rp *RPkt) SetPld(pld common.Payload) *common.Error {
	rp.pld = pld
	var plen int
	if rp.pld != nil {
		// Reset buffer to full size
