...
// Source: github.com/scionproto/scion/go/lib/infra/modules/segfetcher (interfaces: DestProvider,PathDB,RequestAPI,Storage,TRCProvider,Verifier)
...
// MockDestProvider is a mock of DestProvider interface
type MockDestProvider struct {
	ctrl     *gomock.Controller
	recorder *MockDestProviderMockRecorder
}

// MockDestProviderMockRecorder is the mock recorder for MockDestProvider
type MockDestProviderMockRecorder struct {
	mock *MockDestProvider
}

// NewMockDestProvider creates a new mock instance
func NewMockDestProvider(ctrl *gomock.Controller) *MockDestProvider {
	mock := &MockDestProvider{ctrl: ctrl}
	mock.recorder = &MockDestProviderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockDestProvider) EXPECT() *MockDestProviderMockRecorder {
	return m.recorder
}

// GetDest mocks base method
func (m *MockDestProvider) GetDest(arg0 context.Context, arg1 segfetcher.Request) (net.Addr, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDest", arg0, arg1)
	ret0, _ := ret[0].(net.Addr)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDest indicates an expected call of GetDest
func (mr *MockDestProviderMockRecorder) GetDest(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDest", reflect.TypeOf((*MockDestProvider)(nil).GetDest), arg0, arg1)
}
