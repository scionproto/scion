...
func TestGetTRC(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			ISD:  1, Version: scrypto.MaxVersion,
			ExpData: trcs[1], ExpError: false,
		},
		{
		...
		},
		{
			...
			ISD:  2, Version: scrypto.MaxVersion,
			ExpData: trcs[2], ExpError: false,
		},
		{
		...
		},
		{
			...
			ISD:  3, Version: scrypto.MaxVersion,
			ExpData: trcs[3], ExpError: false,
		},
		{
...
func TestGetChain(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			Name: "bad IA=0-1",
			IA:   xtest.MustParseIA("0-ff00:0:1"), Version: scrypto.MaxVersion,
			ExpData: nil, ExpError: true,
		},
		{
			Name: "bad IA=1-0",
			IA:   addr.IA{I: 1, A: 0}, Version: scrypto.MaxVersion,
			ExpData: nil, ExpError: true,
		},
		{
		...
		},
		{
			...
			IA:   xtest.MustParseIA("1-ff00:0:1"), Version: scrypto.MaxVersion,
			ExpData: chains[xtest.MustParseIA("1-ff00:0:1")], ExpError: false,
		},
		{
		...
		},
		{
			...
			IA:   xtest.MustParseIA("3-ff00:0:9"), Version: scrypto.MaxVersion,
			ExpData: chains[xtest.MustParseIA("3-ff00:0:9")], ExpError: false,
		},
		{
...
func TestTRCReqHandler(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			ISD:  42, Version: scrypto.MaxVersion,
			ExpData: nil, ExpError: true,
			RecursionEnabled: true, CacheOnly: false,
		},
		{
...
func TestChainReqHandler(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			IA:   xtest.MustParseIA("1-ff00:0:2"), Version: scrypto.MaxVersion,
			ExpData: nil, ExpError: true,
			RecursionEnabled: true, CacheOnly: true,
		},
		{
