...
func (rp *RPkt) NeedsLocalProcessing() *common.Error {
...
func (rp *RPkt) Process() *common.Error {
...
func (rp *RPkt) processPathlessSVC() (HookResult, *common.Error) {
...
func (rp *RPkt) processDestSelf() (HookResult, *common.Error) {
	if _, err := rp.Payload(); err != nil {
		return HookError, err
	}
	cpld, ok := rp.pld.(*spkt.CtrlPld)
...
func (rp *RPkt) processIFID(pld proto.IFID) (HookResult, *common.Error) {
	...
	// Create base packet
	fwdrp, err := RPktFromSpkt(&spkt.SPkt{
...
func (rp *RPkt) processPathMgmtSelf(pathMgmt proto.PathMgmt) (HookResult, *common.Error) {
...
func (rp *RPkt) processSCMP() (HookResult, *common.Error) {
