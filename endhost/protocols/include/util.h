...
/* Blocks at most `timeout` milliseconds until data is available to be read
 * then recvs the data into the buffer.
 */
 ...
 * system error code is returned, namely those relating to socket() and
 * connect().
 */
