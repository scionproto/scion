...
"""
:mod:`scmp_auth_error_test` --- SCMPAuth error tests
===========================================
"""
# Stdlib
import copy
...
from lib.drkey.auth_scmp.protocol import get_sciond_params, verify_scmp_packet
...
def main():
    args, srcs, dsts = setup_main("scmp_auth_error_test")
