...
class Test(base.TestTopogen):
    """
    Demonstrate and test DRKey.
    Show how a server can locally derive the same key that a client can fetch from
    ...
    The demo consists of the following steps:
      ...
      2. Demonstrate the server side key derivation
      3. Demonstrate the client side key fetching
      4. Compare the keys
    """
