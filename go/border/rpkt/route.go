...
func (rp *RPkt) Route() *common.Error {
...
func (rp *RPkt) RouteResolveSVC() (HookResult, *common.Error) {
...
func (rp *RPkt) RouteResolveSVCAny(svc addr.HostSVC, f OutputFunc) (HookResult, *common.Error) {
...
func (rp *RPkt) RouteResolveSVCMulti(svc addr.HostSVC, f OutputFunc) (HookResult, *common.Error) {
...
func (rp *RPkt) forward() (HookResult, *common.Error) {
	switch rp.DirFrom {
	case DirExternal:
...
func (rp *RPkt) forwardFromExternal() (HookResult, *common.Error) {
...
func (rp *RPkt) forwardFromLocal() (HookResult, *common.Error) {
