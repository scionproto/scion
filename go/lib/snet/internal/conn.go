...
func (c *Conn) ReadFromSCION(b []byte) (int, snet.Addr, error) {
...
func (c *Conn) WriteToSCION(b []byte, raddr snet.Addr) (int, error) {
	if c.conn == nil {
		return 0, common.NewBasicError("Connection not initialized", nil)
	}
	n, err := c.write(b, raddr.(*Addr))
	if err != nil {
...
func (c *Conn) BindSnetAddr() snet.Addr {
	return c.baddr
}
...
func (c *Conn) LocalSnetAddr() snet.Addr {
	return c.laddr
}
...
func (c *Conn) RemoteSnetAddr() snet.Addr {
	return c.raddr
}
