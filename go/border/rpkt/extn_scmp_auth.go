...
func (s *rSCIONPacketSecurityExt) UpdateDirection(dir byte) *common.Error {
...
func (s *rSCIONPacketSecurityExt) Direction() byte {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_DRKEY {
		return scmp_auth_extn.AS_TO_HOST
	}
	return s.Metadata()[0]
}

func (s *rSCIONPacketSecurityExt) ResetMac() *common.Error {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_DRKEY {
		return common.NewError("No MAC for this header", "SecMode", s.SecMode)
	}
...
func (s *rSCIONPacketSecurityExt) UpdateMAC(mac common.RawBytes) *common.Error {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_DRKEY {
		return common.NewError("No MAC for this header", "SecMode", s.SecMode)
	}
...
func (s *rSCIONPacketSecurityExt) MAC() common.RawBytes {
	if s.SecMode == pkt_sec_extn.SCMP_AUTH_DRKEY {
...
func (s *rSCIONPacketSecurityExt) UpdateHeight(height uint8) *common.Error {
...
func hashTreeTotalLength(height uint8) int {
	return pkt_sec_extn.SECMODE_LENGTH + scmp_auth_extn.HASH_TREE_META_LENGTH + scmp_auth_extn.SIGNATURE_LENGTH + int(height)*scmp_auth_extn.HASH_LENGTH
}

func hashTreeHeight(raw common.RawBytes) uint8 {
	return raw[pkt_sec_extn.SECMODE_LENGTH]
}

func (s *rSCIONPacketSecurityExt) Height() uint8 {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_HASH_TREE {
		return 0
	}
...
func (s *rSCIONPacketSecurityExt) UpdateOrder(order common.RawBytes) *common.Error {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_HASH_TREE {
		return common.NewError("No order for this header", "SecMode", s.SecMode)
	}
...
func (s *rSCIONPacketSecurityExt) Order() common.RawBytes {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_HASH_TREE {
...
func (s *rSCIONPacketSecurityExt) UpdateSignature(signature common.RawBytes) *common.Error {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_HASH_TREE {
...
func (s *rSCIONPacketSecurityExt) Signature() common.RawBytes {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_HASH_TREE {
		return s.Authenticator()[0:0]
	}
...
func (s *rSCIONPacketSecurityExt) UpdateHashes(hashes common.RawBytes) *common.Error {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_HASH_TREE {
...
func (s *rSCIONPacketSecurityExt) Hashes() common.RawBytes {
	if s.SecMode != pkt_sec_extn.SCMP_AUTH_HASH_TREE {
		return s.Authenticator()[0:0]
	}
	return s.Authenticator()[scmp_auth_extn.SIGNATURE_LENGTH:]
...
func (s *rSCIONPacketSecurityExt) AlreadySet() bool {
