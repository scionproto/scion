...
func (m *MockSegmentProvider) SegmentsToRegister(arg0 context.Context, arg1 segment.Type) (map[string][]beacon.Beacon, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SegmentsToRegister", arg0, arg1)
	ret0, _ := ret[0].(map[string][]beacon.Beacon)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
