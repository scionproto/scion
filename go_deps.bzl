...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:7NSGy5xafjzYIlow0WAVgTLgMi+EdtTVJAoSbv9HXWA=",
        version = "v0.0.0-20200726165900-d699427278d3",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:QIiQZUW3hKrc6j1oaJ+THVwVbi8H1FTVq6Pw+UdOBwM=",
        version = "v0.0.0-20201105230244-7f2637f4aae3",
    )
    go_repository(
