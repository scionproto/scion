...
func ParsePacket(pktStr string) TaggedLayers {
	return parser.ParsePacket(pktStr)
}
...
var (
	...
	peer2_local = ParsePacket(`
		Ethernet:
		IP4:
		UDP:
		SCION: NextHdr=UDP CurrInfoF=N CurrHopF=N SrcType=IPv4 DstType=IPv4
