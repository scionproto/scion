...
type Topology interface {
	...
	UnderlayNextHop(ifID iface.IfIDType) (*net.UDPAddr, bool)
...
func (t *topologyS) IfIDs() []iface.IfIDType {
	intfs := make([]iface.IfIDType, 0, len(t.Topology.IFInfoMap))
...
func (t *topologyS) UnderlayNextHop(ifID iface.IfIDType) (*net.UDPAddr, bool) {
