...
// the supplied rules. Rules are evaluated in order, and the first that matches the remote ISD-AS wins.
// If in the winning rule Reject is set to true, then the path will be rejected by the policy,
