...
section and in case of a core AS there are two additional section
"Issuer Certificate" section that can contain the following values:
	Issuer [required]
...
"Key Algorithms" section that can contain following values
