...
const PosixSock rctx.SocketType = "posix"
...
func (p posixLoc) Setup(r *Router, ctx *rctx.Ctx, labels prometheus.Labels,
	...
	if err := p.addPosix(r, ctx, bind, labels); err != nil {
		return err
	}
	return nil
}

func (p posixLoc) addPosix(r *Router, ctx *rctx.Ctx, bind *overlay.OverlayAddr,
...
func (p posixExt) Setup(r *Router, ctx *rctx.Ctx, intf *netconf.Interface,
	...
	// No old context. This happens during startup of the router.
	if oldCtx == nil {
		if err := p.addPosixIntf(r, ctx, intf, labels); err != nil {
			return err
		}
		return nil
	}
...
func (p posixExt) addPosixIntf(r *Router, ctx *rctx.Ctx, intf *netconf.Interface,
	labels prometheus.Labels) error {
