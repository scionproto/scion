...
class TRC(object):
    ...
    DEFAULT_EXPIRATION_TIME = 365*24*60*60
    FIELDS_MAP = {
    ...
    def __init__(self, trc_dict):
        ...
        for subject in trc_dict[CORE_ASES_STRING]:
            dec = base64.b64decode(
                ...
                decode("utf-8")
            self.core_ases[subject][ONLINE_KEY_STRING] = base64.b64decode(dec)
    ...
    @classmethod
    def from_values(cls, isd, description, version, core_ases, root_cas, logs,
                    quorum_eepki, root_rains_key, quorum_own_trc,
        ...
        trc_dict = {
            ...
            EXPIRATION_TIME_STRING: now + TRC.DEFAULT_EXPIRATION_TIME,
            CORE_ASES_STRING: core_ases,
            ROOT_CAS_STRING: root_cas,
            PKI_LOGS_STRING: logs,
