...
// OutTransit6 is the IPv6 underlay variant of OutTransit.
func OutTransit6(packetSize int, mac hash.Hash) (string, string, []byte, []byte) {
	var (
		originIA       = ISDAS(4)
		originIP       = PublicIP6(4, 1)
