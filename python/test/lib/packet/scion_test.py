...
class TestSCIONL4PacketParsePayload(object):
    ...
    @patch("lib.packet.scion.CtrlPayloadOuter", autospec=True)
    def _check_l4(self, l4_type, ctrlpOut, scmpp):
        ...
        # Tests
        if l4_type == L4Proto.UDP:
            expected = ctrlpOut.from_raw.return_value.pld.return_value
            ctrlpOut.from_raw.assert_called_once_with(b"praw")
        elif l4_type == L4Proto.SCMP:
