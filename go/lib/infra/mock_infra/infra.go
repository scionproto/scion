...
func (m *MockMessenger) SendBeacon(arg0 context.Context, arg1 *seg.Beacon, arg2 net.Addr, arg3 uint64, arg4 seg.Signer) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendBeacon", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(error)
	return ret0
}

// SendBeacon indicates an expected call of SendBeacon
func (mr *MockMessengerMockRecorder) SendBeacon(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendBeacon", reflect.TypeOf((*MockMessenger)(nil).SendBeacon), arg0, arg1, arg2, arg3, arg4)
}
